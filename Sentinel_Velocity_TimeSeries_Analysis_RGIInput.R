...
outputPath_2 <- setwd("C:/Users/morit/Desktop/tsAnalys/RunningWindow/RW_PamirKara")
setwd(outputPath_2)
...
RW_Matrix_header <- str_remove(RW_Matrix_header, pattern= "RW_Anomaly_RGI60_")
...
write.csv(results.df, file = "AnomalyMatrix.csv")             # writing out results as .csv file in the outputfolder
}
